        ...
        let view = `
            ${characters.results.map(character => `
                <div class="group relative">
                    <div>
                        <img src="${character.image}" alt="${character.name}'s image" class="object-cover w-full h-72 rounded-bl-3xl rounded-tr-3xl transition duration-500 hover:rounded-none">
